...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
	{
		...
		Contract::create(['id' => 11, 'name' => 'test_contract']);
		...
		SimCard::create(['number' => '+7-111-222-333-99', 'contract_id' => 11]);
		SimCardGroup::create(['name' => 'groupe1', 'contract_id' => 11]);
		SimCardGroup::create(['name' => 'groupe2', 'contract_id' => 11]);
		SimCardSimCardGroup::create(['sim_card_id' => 21, 'sim_card_group_id' => 11]);
